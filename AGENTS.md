...
其他定时 job：周三+周日 21:00 复盘（含提示词自进化）、工作日 18:30±30min jitter 的 LLM 规划行情补全、交易日 10/12/14 点舆情采集（采集后**情绪负面极端则条件触发轮动复核**，门槛 5→3，见 `sentiment_service.evaluate_extreme`）。
